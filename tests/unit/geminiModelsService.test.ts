...
describe("fetchGeminiModels", () => {
  ...
  it("fetches models with the key as a query param and strips the models/ prefix", async () => {
    ...
    const models = await fetchGeminiModels("gemini-key", { fetch: fetchFn as unknown as typeof globalThis.fetch });
  ...
  it("throws on a non-ok response", async () => {
    ...
    await expect(
      fetchGeminiModels("gemini-key", { fetch: fetchFn as unknown as typeof globalThis.fetch })
