...
const SAMPLE: CostSummary = {
  ...
  totalRuns: 7,
  totalTokens: { input: 4200, output: 900, cached: 2100, cacheWrite: 120 },
  totalRunsWithTokens: 7,
  perProject: [
    {
      projectId: "p1",
      ...
      premiumRequests: 2,
      runCount: 4,
      tokens: { input: 2800, output: 600, cached: 1400, cacheWrite: 80 },
      runCountWithTokens: 4,
    },
    {
      projectId: "p2",
      projectName: "MOBILE",
      ...
      premiumRequests: 1,
      runCount: 3,
      tokens: { input: 1400, output: 300, cached: 700, cacheWrite: 40 },
