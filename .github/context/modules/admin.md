...
- Task selection is encoded as `#tasks/<taskId>` for browser navigation and sharing. The task detail header exposes a copy-link command to every authenticated viewer and reports clipboard failures inline.
