...
- Built-in provider IDs are retained for compatibility and independent admin overrides, but seed from five shared files: `system_generic_code.md`, `instructions_generic_code.md`, `instructions_feedback_code.md`, `system_review.md`, and `instructions_review.md`. Gerrit, GitHub, and GitLab output differences are not duplicated in these files.
