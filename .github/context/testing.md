...
- Local skill tests cover `LOCAL_SKILLS_PATH` propagation, workspace-relative path fallback, and the single `skills.local_loaded` timeline event containing the sorted local skill list.
