...
| PBAC / authorization | `policyEngine`, `permissions`, `pbacStores`, `adminPoliciesRoutes`, `adminServerRbac` (owner/peer/group/admin isolation across projects, tasks, integrations, agents, prompts, OAuth apps; project-owner delegation and additive linked-resource grants; cross-owner reference and stream/aggregate leak regressions) |
