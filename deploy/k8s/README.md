...
sandbox**; OpenShell schedules agent sandboxes as Kubernetes Pods.

> The OpenShell Kubernetes path is upstream **experimental**. Keep Docker as the
> default runtime until the acceptance criteria in
> [`docs/adr/0001-openshell-agent-runtime.md`](../../docs/adr/0001-openshell-agent-runtime.md)
> are met. Runtime is selectable per project/agent from the admin UI (Runtime tab).
...
## 2. Install the OpenShell gateway
